...
public class SimpleContext implements Context, Pipeline {
  ...
  public void addJspMapping(String s) {
  ...
  public void setTldNamespaceAware(boolean b) {
  ...
  public Container map(Request request, boolean b) {
    return (Container) children.get(servletMappings.get(((HttpRequest) request).getDecodedRequestURI()));
  }
